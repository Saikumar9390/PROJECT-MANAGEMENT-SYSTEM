			...
			<tbody>
				<?php while($files=mysqli_fetch_assoc($result)){?> 
					<tr>
						...
						<td>
							<a href="index2.php?file_id=<?php echo $files['id']?>"><button type="button" style="background-color:green;width: 100% ;height: 100%;" class="btn btn-danger">Download</button></a>
        </a>
						</td>
					</tr>
					<?php }?>
